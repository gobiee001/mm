...
:: Set script file to aim_joystick.js by default
set "SCRIPT_FILE=%~dp0aim_joystick.js"
...
:: Check relative path from this batch script (nested under Frida_finalScripts/joystick)
