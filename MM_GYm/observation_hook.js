...
(function () {
    ...
    // =========================================================================
    // 2. RESOLVE PLAYER NATIVE FUNCTIONS
    // =========================================================================
    ...
    // =========================================================================
    // 6. CACHING HOOKS (Capturing pointers and maintaining object references)
    // =========================================================================
    ...
    // =========================================================================
    // 7. COMPACT OBSERVATION COLLECTORS
    // =========================================================================
    ...
    function collectPlayerState() {
        ...
        if (!playerControllerPtr.isNull()) {
            // 1. Position from SoldierView CCNode
    ...
    // Enemy State Collector
    function collectEnemyState() {
        const enemies = [];
        if (enemyManagerPtr.isNull() || getNodePosition === null) {
            return enemies;
        }
        ...
        // 1. Hawk Drones (Offset 0x14 | Type 0)
        iterateDict(0x14, 0, function (hawkPtr, id, type) {
            getNodePosition(hawkPtr, mapXBuf, mapYBuf);
            const x = mapXBuf.readFloat();
            const y = mapYBuf.readFloat();
        ...
        // 2. Humanoid Drones (Offset 0x18 | Type 1)
        ...
        // 3. Worm Drones (Offset 0x1c | Type 2)
