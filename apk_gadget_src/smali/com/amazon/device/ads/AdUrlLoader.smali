...
.method public constructor <init>(Lcom/amazon/device/ads/ThreadUtils$ThreadRunner;Lcom/amazon/device/ads/AdWebViewClient;Lcom/amazon/device/ads/WebRequest$WebRequestFactory;Lcom/amazon/device/ads/AdControlAccessor;Lcom/amazon/device/ads/WebUtils2;Lcom/amazon/device/ads/MobileAdsLoggerFactory;Lcom/amazon/device/ads/DeviceInfo;)V
    ...
    .param p2, "adWebViewClient"    # Lcom/amazon/device/ads/AdWebViewClient;
    .param p3, "webRequestFactory"    # Lcom/amazon/device/ads/WebRequest$WebRequestFactory;
    .param p4, "adControlAccessor"    # Lcom/amazon/device/ads/AdControlAccessor;
    .param p5, "webUtils"    # Lcom/amazon/device/ads/WebUtils2;
    .param p6, "loggerFactory"    # Lcom/amazon/device/ads/MobileAdsLoggerFactory;
    .param p7, "deviceInfo"    # Lcom/amazon/device/ads/DeviceInfo;
...
.method static synthetic access$000(Lcom/amazon/device/ads/AdUrlLoader;Ljava/lang/String;ZLcom/amazon/device/ads/PreloadCallback;)V
    .locals 0
    .param p0, "x0"    # Lcom/amazon/device/ads/AdUrlLoader;
    .param p1, "x1"    # Ljava/lang/String;
    .param p2, "x2"    # Z
    .param p3, "x3"    # Lcom/amazon/device/ads/PreloadCallback;
...
.method private loadUrlInThread(Ljava/lang/String;ZLcom/amazon/device/ads/PreloadCallback;)V
    ...
    .line 89
    .local v8, "webRequest":Lcom/amazon/device/ads/WebRequest;
    sget-object v0, Lcom/amazon/device/ads/AdUrlLoader;->LOGTAG:Ljava/lang/String;

    invoke-virtual {v8, v0}, Lcom/amazon/device/ads/WebRequest;->setExternalLogTag(Ljava/lang/String;)V

    .line 90
    invoke-virtual {v8, v5}, Lcom/amazon/device/ads/WebRequest;->enableLogUrl(Z)V

    .line 91
    invoke-virtual {v8, p1}, Lcom/amazon/device/ads/WebRequest;->setUrlString(Ljava/lang/String;)V

    .line 92
    const-string v0, "User-Agent"

    iget-object v1, p0, Lcom/amazon/device/ads/AdUrlLoader;->deviceInfo:Lcom/amazon/device/ads/DeviceInfo;

    invoke-virtual {v1}, Lcom/amazon/device/ads/DeviceInfo;->getUserAgentString()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v8, v0, v1}, Lcom/amazon/device/ads/WebRequest;->putHeader(Ljava/lang/String;Ljava/lang/String;)V

    .line 93
    const/4 v7, 0x0

    .line 96
    .local v7, "response":Lcom/amazon/device/ads/WebRequest$WebResponse;
    :try_start_0
    invoke-virtual {v8}, Lcom/amazon/device/ads/WebRequest;->makeCall()Lcom/amazon/device/ads/WebRequest$WebResponse;
    :try_end_0
    ...
    .line 104
    invoke-virtual {v7}, Lcom/amazon/device/ads/WebRequest$WebResponse;->getResponseReader()Lcom/amazon/device/ads/ResponseReader;
    ...
    .line 107
    iget-object v9, p0, Lcom/amazon/device/ads/AdUrlLoader;->threadRunner:Lcom/amazon/device/ads/ThreadUtils$ThreadRunner;
    ...
    invoke-virtual {v9, v0, v1, v2}, Lcom/amazon/device/ads/ThreadUtils$ThreadRunner;->execute(Ljava/lang/Runnable;Lcom/amazon/device/ads/ThreadUtils$ExecutionStyle;Lcom/amazon/device/ads/ThreadUtils$ExecutionThread;)V
    ...
    .line 100
    .local v6, "e":Lcom/amazon/device/ads/WebRequest$WebRequestException;
    iget-object v0, p0, Lcom/amazon/device/ads/AdUrlLoader;->logger:Lcom/amazon/device/ads/MobileAdsLogger;

    const-string v1, "Could not load URL (%s) into AdContainer: %s"
    ...
    invoke-virtual {v6}, Lcom/amazon/device/ads/WebRequest$WebRequestException;->getMessage()Ljava/lang/String;
    ...
    .line 118
    .end local v6    # "e":Lcom/amazon/device/ads/WebRequest$WebRequestException;
...
.method public loadUrl(Ljava/lang/String;ZLcom/amazon/device/ads/PreloadCallback;)V
    ...
    .prologue
    .line 69
    iget-object v1, p0, Lcom/amazon/device/ads/AdUrlLoader;->webUtils:Lcom/amazon/device/ads/WebUtils2;

    invoke-virtual {v1, p1}, Lcom/amazon/device/ads/WebUtils2;->getScheme(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 72
    :cond_0
    iget-object v1, p0, Lcom/amazon/device/ads/AdUrlLoader;->threadRunner:Lcom/amazon/device/ads/ThreadUtils$ThreadRunner;

    new-instance v2, Lcom/amazon/device/ads/AdUrlLoader$1;

    invoke-direct {v2, p0, p1, p2, p3}, Lcom/amazon/device/ads/AdUrlLoader$1;-><init>(Lcom/amazon/device/ads/AdUrlLoader;Ljava/lang/String;ZLcom/amazon/device/ads/PreloadCallback;)V
    ...
    sget-object v4, Lcom/amazon/device/ads/ThreadUtils$ExecutionThread;->BACKGROUND_THREAD:Lcom/amazon/device/ads/ThreadUtils$ExecutionThread;
...
.method public setAdWebViewClientListener(Lcom/amazon/device/ads/AdWebViewClient$AdWebViewClientListener;)V
    .locals 1
    .param p1, "adWebViewClientListener"    # Lcom/amazon/device/ads/AdWebViewClient$AdWebViewClientListener;
