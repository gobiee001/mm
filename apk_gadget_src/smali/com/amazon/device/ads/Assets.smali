...
.method protected constructor <init>(Lcom/amazon/device/ads/MobileAdsInfoStore;Lcom/amazon/device/ads/FileHandlerFactory;Lcom/amazon/device/ads/Settings;Lcom/amazon/device/ads/Metrics;)V
    ...
    .param p3, "settings"    # Lcom/amazon/device/ads/Settings;
    .param p4, "metrics"    # Lcom/amazon/device/ads/Metrics;
...
.method private writeAssetToDisk(Lcom/amazon/device/ads/Assets$CircuitBreaker;[BLjava/lang/String;)V
    .locals 6
    .param p1, "breaker"    # Lcom/amazon/device/ads/Assets$CircuitBreaker;
    .param p2, "bytes"    # [B
    ...
    .line 156
    :cond_0
    iget-object v2, p0, Lcom/amazon/device/ads/Assets;->fileHandlerFactory:Lcom/amazon/device/ads/FileHandlerFactory;

    invoke-interface {v2, p3}, Lcom/amazon/device/ads/FileHandlerFactory;->createFileOutputHandler(Ljava/lang/String;)Lcom/amazon/device/ads/FileOutputHandler;

    move-result-object v1

    .line 157
    .local v1, "fileOutputHandler":Lcom/amazon/device/ads/FileOutputHandler;
    if-nez v1, :cond_1

    .line 159
    iget-object v2, p0, Lcom/amazon/device/ads/Assets;->logger:Lcom/amazon/device/ads/MobileAdsLogger;

    const-string v3, "Could not create output handler for asset file."
    ...
    .line 162
    :cond_1
    sget-object v2, Lcom/amazon/device/ads/FileOutputHandler$WriteMethod;->OVERWRITE:Lcom/amazon/device/ads/FileOutputHandler$WriteMethod;

    invoke-virtual {v1, v2}, Lcom/amazon/device/ads/FileOutputHandler;->open(Lcom/amazon/device/ads/FileOutputHandler$WriteMethod;)Z
    ...
    .line 166
    :try_start_0
    invoke-virtual {v1, p2}, Lcom/amazon/device/ads/FileOutputHandler;->write([B)V
    :try_end_0
    ...
    const-string v3, "Caught IOException while writing asset to disk: %s"
...
.method private writeAssetsToDisk()Z
    ...
    .line 122
    .local v0, "breaker":Lcom/amazon/device/ads/Assets$CircuitBreaker;
...
.method public declared-synchronized ensureAssetsCreated()Z
    ...
    :try_start_0
    iget-object v6, p0, Lcom/amazon/device/ads/Assets;->baseFilePath:Ljava/lang/String;
    ...
    iput-object v6, p0, Lcom/amazon/device/ads/Assets;->baseFilePath:Ljava/lang/String;
    ...
    .line 97
    .local v2, "time":J
    iget-object v6, p0, Lcom/amazon/device/ads/Assets;->settings:Lcom/amazon/device/ads/Settings;

    const-string v7, "mraid-assets-version"

    const/4 v8, 0x0

    invoke-virtual {v6, v7, v8}, Lcom/amazon/device/ads/Settings;->getInt(Ljava/lang/String;I)I

    move-result v1

    .line 98
    .local v1, "writtenVersion":I
    const/4 v0, 0x0

    .line 99
    .local v0, "assetsCreated":Z
    if-ge v1, v9, :cond_1

    .line 101
    iget-object v6, p0, Lcom/amazon/device/ads/Assets;->logger:Lcom/amazon/device/ads/MobileAdsLogger;

    const-string v7, "Writing assets to disk: version %d"
    ...
    const-string v6, "mraid-assets-version"

    const/4 v7, 0x5

    invoke-virtual {v4, v6, v7}, Lcom/amazon/device/ads/Settings;->putInt(Ljava/lang/String;I)V
    ...
    invoke-static {v6, v7}, Lcom/amazon/device/ads/NumberUtils;->convertToMillisecondsFromNanoseconds(J)J
    ...
    sget-object v4, Lcom/amazon/device/ads/Metrics$MetricType;->ASSETS_CREATED_LATENCY:Lcom/amazon/device/ads/Metrics$MetricType;

    :goto_1
    invoke-virtual {v6, v4, v2, v3}, Lcom/amazon/device/ads/MetricsCollector;->publishMetricInMilliseconds(Lcom/amazon/device/ads/Metrics$MetricType;J)V
    ...
    .line 107
    :cond_2
    iget-object v5, p0, Lcom/amazon/device/ads/Assets;->metrics:Lcom/amazon/device/ads/Metrics;

    invoke-virtual {v5}, Lcom/amazon/device/ads/Metrics;->getMetricsCollector()Lcom/amazon/device/ads/MetricsCollector;

    move-result-object v5

    sget-object v6, Lcom/amazon/device/ads/Metrics$MetricType;->ASSETS_FAILED:Lcom/amazon/device/ads/Metrics$MetricType;
    ...
    .line 84
    .end local v0    # "assetsCreated":Z
    .end local v1    # "writtenVersion":I
    .end local v2    # "time":J
    :catchall_0
    move-exception v4
    ...
    .line 113
    .restart local v0    # "assetsCreated":Z
    .restart local v1    # "writtenVersion":I
    .restart local v2    # "time":J
    :cond_3
    :try_start_2
    sget-object v4, Lcom/amazon/device/ads/Metrics$MetricType;->ASSETS_ENSURED_LATENCY:Lcom/amazon/device/ads/Metrics$MetricType;
    :try_end_2
