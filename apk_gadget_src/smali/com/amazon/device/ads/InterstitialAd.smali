...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/amazon/device/ads/InterstitialAd$5;,
...
.method public constructor <init>(Landroid/app/Activity;)V
    ...
    invoke-direct/range {v0 .. v6}, Lcom/amazon/device/ads/InterstitialAd;-><init>(Landroid/app/Activity;Lcom/amazon/device/ads/MobileAdsLoggerFactory;Lcom/amazon/device/ads/AdControllerFactory;Lcom/amazon/device/ads/IntentBuilderFactory;Lcom/amazon/device/ads/AdRegistrationExecutor;Lcom/amazon/device/ads/AdLoadStarter;)V

    .line 90
    return-void
.end method

.method constructor <init>(Landroid/app/Activity;Lcom/amazon/device/ads/MobileAdsLoggerFactory;Lcom/amazon/device/ads/AdControllerFactory;Lcom/amazon/device/ads/IntentBuilderFactory;Lcom/amazon/device/ads/AdRegistrationExecutor;Lcom/amazon/device/ads/AdLoadStarter;)V
    .locals 8
    .param p1, "activity"    # Landroid/app/Activity;
    ...
    .param p4, "intentBuilderFactory"    # Lcom/amazon/device/ads/IntentBuilderFactory;
    ...
    invoke-direct/range {v0 .. v7}, Lcom/amazon/device/ads/InterstitialAd;-><init>(Landroid/app/Activity;Lcom/amazon/device/ads/MobileAdsLoggerFactory;Lcom/amazon/device/ads/AdListenerExecutorFactory;Lcom/amazon/device/ads/AdControllerFactory;Lcom/amazon/device/ads/IntentBuilderFactory;Lcom/amazon/device/ads/AdRegistrationExecutor;Lcom/amazon/device/ads/AdLoadStarter;)V
...
.method constructor <init>(Landroid/app/Activity;Lcom/amazon/device/ads/MobileAdsLoggerFactory;Lcom/amazon/device/ads/AdListenerExecutorFactory;Lcom/amazon/device/ads/AdControllerFactory;Lcom/amazon/device/ads/IntentBuilderFactory;Lcom/amazon/device/ads/AdRegistrationExecutor;Lcom/amazon/device/ads/AdLoadStarter;)V
    ...
    .param p1, "activity"    # Landroid/app/Activity;
    .param p2, "loggerFactory"    # Lcom/amazon/device/ads/MobileAdsLoggerFactory;
    .param p3, "adListenerExecutorFactory"    # Lcom/amazon/device/ads/AdListenerExecutorFactory;
    .param p4, "adControllerFactory"    # Lcom/amazon/device/ads/AdControllerFactory;
    .param p5, "intentBuilderFactory"    # Lcom/amazon/device/ads/IntentBuilderFactory;
...
.method didAdActivityFail()Z
    ...
    .prologue
    .line 292
    iget-boolean v1, p0, Lcom/amazon/device/ads/InterstitialAd;->isThisAdShowing:Z
...
.method public showAd()Z
    ...
    .line 309
    iget-object v4, p0, Lcom/amazon/device/ads/InterstitialAd;->logger:Lcom/amazon/device/ads/MobileAdsLogger;

    const-string v5, "The ad could not be shown because it previously failed to show. Please load a new ad."
    ...
    .line 312
    :cond_1
    iget-object v4, p0, Lcom/amazon/device/ads/InterstitialAd;->previousAdExpired:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    const-string v5, "This interstitial ad has expired. Please load another ad."

    invoke-virtual {v4, v5}, Lcom/amazon/device/ads/MobileAdsLogger;->w(Ljava/lang/String;)V
    ...
    .line 318
    .local v2, "renderLatencyStartTime":J
    invoke-virtual {p0}, Lcom/amazon/device/ads/InterstitialAd;->isReadyToShow()Z
    ...
    invoke-virtual {v4}, Lcom/amazon/device/ads/AdController;->isExpired()Z
    ...
    const-string v5, "Another interstitial ad is currently showing. Please wait for the InterstitialAdListener.onAdDismissed callback of the other ad."
    ...
    invoke-virtual {v4}, Lcom/amazon/device/ads/AdController;->startAdDrawing()Z
    ...
    .line 333
    iput-boolean v5, p0, Lcom/amazon/device/ads/InterstitialAd;->isThisAdShowing:Z
    ...
    invoke-virtual {v4, v5, v2, v3}, Lcom/amazon/device/ads/MetricsCollector;->stopMetricInMillisecondsFromNanoseconds(Lcom/amazon/device/ads/Metrics$MetricType;J)V
    ...
    sget-object v5, Lcom/amazon/device/ads/Metrics$MetricType;->AD_SHOW_DURATION:Lcom/amazon/device/ads/Metrics$MetricType;

    invoke-virtual {v4, v5, v2, v3}, Lcom/amazon/device/ads/MetricsCollector;->startMetricInMillisecondsFromNanoseconds(Lcom/amazon/device/ads/Metrics$MetricType;J)V
    ...
    invoke-static {v4}, Lcom/amazon/device/ads/AdControllerFactory;->cacheAdController(Lcom/amazon/device/ads/AdController;)V
    ...
    invoke-virtual {v4}, Lcom/amazon/device/ads/AdController;->resetToReady()V
    ...
    invoke-virtual {v1, v4}, Lcom/amazon/device/ads/MetricsCollector;->stopMetric(Lcom/amazon/device/ads/Metrics$MetricType;)V
    ...
    const-string v5, "Interstitial ad could not be shown."
    ...
    const-string v5, "The interstitial ad cannot be shown because it has not loaded successfully. Please call loadAd(AdTargetingOptions) to load an ad first."
    ...
    const-string v5, "The interstitial ad cannot be shown because it is still loading. Please wait for the AdListener.onAdLoaded() callback before showing the ad."
    ...
    const-string v5, "The interstitial ad cannot be shown because it is already displayed on the screen. Please wait for the InterstitialAdListener.onAdDismissed() callback and then load a new ad."
    ...
    const-string v5, "An interstitial ad is not ready to show."
...
.method showAdInActivity()Z
    ...
    .prologue
    .line 389
    iget-object v2, p0, Lcom/amazon/device/ads/InterstitialAd;->intentBuilderFactory:Lcom/amazon/device/ads/IntentBuilderFactory;

    invoke-virtual {v2}, Lcom/amazon/device/ads/IntentBuilderFactory;->createIntentBuilder()Lcom/amazon/device/ads/IntentBuilder;

    move-result-object v0

    .line 390
    .local v0, "intentBuilder":Lcom/amazon/device/ads/IntentBuilder;
    const-class v2, Lcom/amazon/device/ads/AdActivity;

    invoke-virtual {v0, v2}, Lcom/amazon/device/ads/IntentBuilder;->withClass(Ljava/lang/Class;)Lcom/amazon/device/ads/IntentBuilder;
    ...
    invoke-virtual {v2, v3}, Lcom/amazon/device/ads/IntentBuilder;->withContext(Landroid/content/Context;)Lcom/amazon/device/ads/IntentBuilder;

    move-result-object v2

    iget-object v3, p0, Lcom/amazon/device/ads/InterstitialAd;->activity:Landroid/app/Activity;

    invoke-virtual {v2, v3}, Lcom/amazon/device/ads/IntentBuilder;->withActivity(Landroid/app/Activity;)Lcom/amazon/device/ads/IntentBuilder;

    move-result-object v2

    const-string v3, "adapter"

    const-class v4, Lcom/amazon/device/ads/InterstitialAdActivityAdapter;

    invoke-virtual {v4}, Ljava/lang/Class;->getName()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v2, v3, v4}, Lcom/amazon/device/ads/IntentBuilder;->withExtra(Ljava/lang/String;Ljava/lang/String;)Lcom/amazon/device/ads/IntentBuilder;

    move-result-object v2

    invoke-virtual {v2}, Lcom/amazon/device/ads/IntentBuilder;->fireIntent()Z
    ...
    .line 398
    iget-object v2, p0, Lcom/amazon/device/ads/InterstitialAd;->logger:Lcom/amazon/device/ads/MobileAdsLogger;

    const-string v3, "Failed to show the interstitial ad because AdActivity could not be found."
