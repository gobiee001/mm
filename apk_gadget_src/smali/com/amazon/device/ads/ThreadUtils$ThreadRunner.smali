...
.method constructor <init>()V
    ...
    invoke-direct {p0, v1}, Lcom/amazon/device/ads/ThreadUtils$ThreadRunner;-><init>(Lcom/amazon/device/ads/MobileAdsLoggerFactory;)V
    ...
    .line 137
    .local v0, "threadVerify":Lcom/amazon/device/ads/ThreadUtils$ThreadVerify;
...
.method public execute(Ljava/lang/Runnable;Lcom/amazon/device/ads/ThreadUtils$ExecutionStyle;Lcom/amazon/device/ads/ThreadUtils$ExecutionThread;)V
    ...
    .param p2, "executionStyle"    # Lcom/amazon/device/ads/ThreadUtils$ExecutionStyle;
    .param p3, "executionThread"    # Lcom/amazon/device/ads/ThreadUtils$ExecutionThread;
    ...
    .line 162
    iget-object v2, p0, Lcom/amazon/device/ads/ThreadUtils$ThreadRunner;->executors:Ljava/util/HashMap;
    ...
    .line 163
    .local v1, "executorsForStyle":Ljava/util/HashMap;, "Ljava/util/HashMap<Lcom/amazon/device/ads/ThreadUtils$ExecutionThread;Lcom/amazon/device/ads/ThreadUtils$RunnableExecutor;>;"
    if-nez v1, :cond_0

    .line 165
    iget-object v2, p0, Lcom/amazon/device/ads/ThreadUtils$ThreadRunner;->logger:Lcom/amazon/device/ads/MobileAdsLogger;

    const-string v3, "No executor available for %s execution style."
    ...
    .line 169
    .local v0, "executor":Lcom/amazon/device/ads/ThreadUtils$RunnableExecutor;
    if-nez v0, :cond_1

    .line 171
    iget-object v2, p0, Lcom/amazon/device/ads/ThreadUtils$ThreadRunner;->logger:Lcom/amazon/device/ads/MobileAdsLogger;

    const-string v3, "No executor available for %s execution style on % execution thread."
...
.method public varargs executeAsyncTask(Lcom/amazon/device/ads/ThreadUtils$ExecutionStyle;Lcom/amazon/device/ads/ThreadUtils$ExecutionThread;Lcom/amazon/device/ads/ThreadUtils$MobileAdsAsyncTask;[Ljava/lang/Object;)V
    .locals 2
    .param p1, "executionStyle"    # Lcom/amazon/device/ads/ThreadUtils$ExecutionStyle;
    .param p2, "executionThread"    # Lcom/amazon/device/ads/ThreadUtils$ExecutionThread;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
            "Ljava/lang/Object;",
    ...
    .prologue
    .line 190
    .local p3, "task":Lcom/amazon/device/ads/ThreadUtils$MobileAdsAsyncTask;, "Lcom/amazon/device/ads/ThreadUtils$MobileAdsAsyncTask<TT;**>;"
...
.method public varargs executeAsyncTask(Lcom/amazon/device/ads/ThreadUtils$MobileAdsAsyncTask;[Ljava/lang/Object;)V
    ...
    .prologue
    .line 183
    .local p1, "task":Lcom/amazon/device/ads/ThreadUtils$MobileAdsAsyncTask;, "Lcom/amazon/device/ads/ThreadUtils$MobileAdsAsyncTask<TT;**>;"
...
.method public withExecutor(Lcom/amazon/device/ads/ThreadUtils$RunnableExecutor;)Lcom/amazon/device/ads/ThreadUtils$ThreadRunner;
    ...
    .line 151
    .local v0, "executorsForStyle":Ljava/util/HashMap;, "Ljava/util/HashMap<Lcom/amazon/device/ads/ThreadUtils$ExecutionThread;Lcom/amazon/device/ads/ThreadUtils$RunnableExecutor;>;"
    if-nez v0, :cond_0

    .line 153
    new-instance v0, Ljava/util/HashMap;

    .end local v0    # "executorsForStyle":Ljava/util/HashMap;, "Ljava/util/HashMap<Lcom/amazon/device/ads/ThreadUtils$ExecutionThread;Lcom/amazon/device/ads/ThreadUtils$RunnableExecutor;>;"
    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    .line 154
    .restart local v0    # "executorsForStyle":Ljava/util/HashMap;, "Ljava/util/HashMap<Lcom/amazon/device/ads/ThreadUtils$ExecutionThread;Lcom/amazon/device/ads/ThreadUtils$RunnableExecutor;>;"
    iget-object v1, p0, Lcom/amazon/device/ads/ThreadUtils$ThreadRunner;->executors:Ljava/util/HashMap;
