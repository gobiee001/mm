...
.method constructor <init>(Landroid/view/ViewGroup;Lcom/amazon/device/ads/WebViewFactory;Lcom/amazon/device/ads/AndroidTargetUtils$AndroidClassAdapter;)V
    ...
    .param p3, "androidClassAdapter"    # Lcom/amazon/device/ads/AndroidTargetUtils$AndroidClassAdapter;
...
.method static synthetic access$100(Lcom/amazon/device/ads/ViewManager;)Lcom/amazon/device/ads/MobileAdsLogger;
    .locals 1
    .param p0, "x0"    # Lcom/amazon/device/ads/ViewManager;
...
.method private getCurrentWebView()Landroid/webkit/WebView;
    ...
    invoke-virtual {p0, v1}, Lcom/amazon/device/ads/ViewManager;->getContext(Landroid/view/View;)Landroid/content/Context;
    ...
    const-string v2, "Could not create WebView"
...
.method public addJavascriptInterface(Ljava/lang/Object;ZLjava/lang/String;)V
    .locals 4
    .param p1, "javascriptInterface"    # Ljava/lang/Object;
    .param p2, "preload"    # Z
...
.method createWebView(Landroid/content/Context;)Landroid/webkit/WebView;
    ...
    .line 214
    iget-object v3, p0, Lcom/amazon/device/ads/ViewManager;->webViewFactory:Lcom/amazon/device/ads/WebViewFactory;

    invoke-virtual {v3, p1}, Lcom/amazon/device/ads/WebViewFactory;->createWebView(Landroid/content/Context;)Landroid/webkit/WebView;
    ...
    sget-object v4, Lcom/amazon/device/ads/ViewManager;->LOGTAG:Ljava/lang/String;

    invoke-virtual {v3, v6, v1, v4}, Lcom/amazon/device/ads/WebViewFactory;->setJavaScriptEnabledForWebView(ZLandroid/webkit/WebView;Ljava/lang/String;)Z
    ...
    invoke-virtual {v3, v5}, Lcom/amazon/device/ads/AndroidTargetUtils$AndroidClassAdapter$WebSettingsAdapter;->setMediaPlaybackRequiresUserGesture(Z)V
    ...
    invoke-direct {v3, p0, v2}, Lcom/amazon/device/ads/ViewManager$AdWebChromeClient;-><init>(Lcom/amazon/device/ads/ViewManager;Lcom/amazon/device/ads/ViewManager$1;)V
    ...
    .line 232
    iget-boolean v2, p0, Lcom/amazon/device/ads/ViewManager;->disableHardwareAcceleration:Z
...
.method public loadData(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLcom/amazon/device/ads/PreloadCallback;)V
    ...
    .param p2, "mimeType"    # Ljava/lang/String;
    .param p3, "encoding"    # Ljava/lang/String;
    .param p4, "shouldPreload"    # Z
    .param p5, "callback"    # Lcom/amazon/device/ads/PreloadCallback;
...
.method public loadDataWithBaseURL(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLcom/amazon/device/ads/PreloadCallback;)V
    ...
    .param p4, "encoding"    # Ljava/lang/String;
    .param p5, "historyUrl"    # Ljava/lang/String;
    .param p6, "shouldPreload"    # Z
    .param p7, "callback"    # Lcom/amazon/device/ads/PreloadCallback;
...
.method public removePreviousInterfaces()V
    ...
    .line 451
    iget-object v2, p0, Lcom/amazon/device/ads/ViewManager;->javascriptInterfaceNames:Ljava/util/Set;
    ...
    invoke-virtual {p0, v2, v3}, Lcom/amazon/device/ads/ViewManager;->setWebView(Landroid/webkit/WebView;Z)V

    .line 459
    iget-object v2, p0, Lcom/amazon/device/ads/ViewManager;->currentWebView:Landroid/webkit/WebView;

    const-string v3, "originalWebView"

    invoke-virtual {v2, v3}, Landroid/webkit/WebView;->setContentDescription(Ljava/lang/CharSequence;)V
...
.method setWebView(Landroid/webkit/WebView;Z)V
    .locals 3
    .param p1, "webView"    # Landroid/webkit/WebView;
    .param p2, "shouldDestroyPrevious"    # Z
    ...
    invoke-virtual {p0, v1}, Lcom/amazon/device/ads/ViewManager;->addViewToParent(Landroid/webkit/WebView;)V
    ...
    invoke-virtual {p0, v1}, Lcom/amazon/device/ads/ViewManager;->listenForKey(Landroid/view/View$OnKeyListener;)V
...
.method public stashView()V
    ...
    .line 292
    :goto_0
    invoke-virtual {p0, v0, v3}, Lcom/amazon/device/ads/ViewManager;->setWebView(Landroid/webkit/WebView;Z)V
