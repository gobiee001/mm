.class public Lcom/cuebiq/cuebiqsdk/api/BeaRequest;
.super Lcom/cuebiq/cuebiqsdk/api/CuebiqRequest;
.source "BeaRequest.java"


# direct methods
.method public constructor <init>(Lcom/cuebiq/cuebiqsdk/model/wrapper/TrackRequest;Ljava/lang/String;)V
    .locals 3
    .param p1, "data"    # Lcom/cuebiq/cuebiqsdk/model/wrapper/TrackRequest;
    ...
    .line 17
    iget-object v1, p0, Lcom/cuebiq/cuebiqsdk/api/BeaRequest;->mBuilder:Lokhttp3/HttpUrl$Builder;

    const-string v2, "/bea/30004"

    invoke-virtual {v1, v2}, Lokhttp3/HttpUrl$Builder;->encodedPath(Ljava/lang/String;)Lokhttp3/HttpUrl$Builder;

    .line 19
    invoke-virtual {p1}, Lcom/cuebiq/cuebiqsdk/model/wrapper/TrackRequest;->toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/cuebiq/cuebiqsdk/api/BeaRequest;->mBuilder:Lokhttp3/HttpUrl$Builder;
    ...
    :goto_0
    iput-object v1, p0, Lcom/cuebiq/cuebiqsdk/api/BeaRequest;->mRequest:Lokhttp3/Request;
