...
.field private static zzicm:Lcom/google/android/gms/gcm/GoogleCloudMessaging;

.field private static final zzicp:Ljava/util/concurrent/atomic/AtomicInteger;
...
.field private final zzico:Ljava/util/Map;
...
.field private final zzicq:Ljava/util/concurrent/BlockingQueue;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzicp:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzico:Ljava/util/Map;

    new-instance v0, Ljava/util/concurrent/LinkedBlockingQueue;

    invoke-direct {v0}, Ljava/util/concurrent/LinkedBlockingQueue;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzicq:Ljava/util/concurrent/BlockingQueue;
    ...
    iput-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzicr:Landroid/os/Messenger;
...
.method public static declared-synchronized getInstance(Landroid/content/Context;)Lcom/google/android/gms/gcm/GoogleCloudMessaging;
    ...
    :try_start_0
    sget-object v0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzicm:Lcom/google/android/gms/gcm/GoogleCloudMessaging;
    ...
    sput-object v0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzicm:Lcom/google/android/gms/gcm/GoogleCloudMessaging;

    invoke-virtual {p0}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object v2

    iput-object v2, v0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzair:Landroid/content/Context;
...
.method private final zza(Landroid/os/Bundle;Z)Landroid/content/Intent;
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzair:Landroid/content/Context;

    invoke-static {v0}, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzdl(Landroid/content/Context;)I
    ...
    sget-object v2, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzicp:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v2, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzicr:Landroid/os/Messenger;
    ...
    :goto_1
    :try_start_0
    iget-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzicq:Ljava/util/concurrent/BlockingQueue;
...
.method private final declared-synchronized zzauw()V
    .locals 1

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzicn:Landroid/app/PendingIntent;
    ...
    iput-object v0, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzicn:Landroid/app/PendingIntent;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static zzdl(Landroid/content/Context;)I
    .locals 3
...
.method private final zzf(Landroid/content/Intent;)Z
    ...
    iget-object v1, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzico:Ljava/util/Map;
...
.method private final declared-synchronized zzg(Landroid/content/Intent;)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzair:Landroid/content/Context;
    ...
    iget-object v1, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzicn:Landroid/app/PendingIntent;
...
.method public close()V
    ...
    sput-object v0, Lcom/google/android/gms/gcm/zza;->zzibw:Lcom/google/android/gms/gcm/zza;

    invoke-direct {p0}, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzauw()V
...
.method public varargs declared-synchronized register([Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/google/android/gms/iid/zzl;->zzdo(Landroid/content/Context;)Z
...
.method public send(Ljava/lang/String;Ljava/lang/String;JLandroid/os/Bundle;)V
    ...
    :goto_0
    iget-object v4, p0, Lcom/google/android/gms/gcm/GoogleCloudMessaging;->zzair:Landroid/content/Context;
