...
# static fields
.field private static zznzp:Lcom/google/firebase/iid/zzx;
...
.field final zznzs:Ljava/util/Queue;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Queue",
            "<",
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/firebase/iid/zzx;->zznzq:Landroid/support/v4/util/SimpleArrayMap;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/google/firebase/iid/zzx;->zznzr:Ljava/lang/Boolean;

    new-instance v0, Ljava/util/ArrayDeque;

    invoke-direct {v0}, Ljava/util/ArrayDeque;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/iid/zzx;->zznzs:Ljava/util/Queue;

    new-instance v0, Ljava/util/ArrayDeque;

    invoke-direct {v0}, Ljava/util/ArrayDeque;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/iid/zzx;->zznzt:Ljava/util/Queue;

    return-void
.end method

.method public static declared-synchronized zzcjk()Lcom/google/firebase/iid/zzx;
    .locals 2
    ...
    :try_start_0
    sget-object v0, Lcom/google/firebase/iid/zzx;->zznzp:Lcom/google/firebase/iid/zzx;
    ...
    sput-object v0, Lcom/google/firebase/iid/zzx;->zznzp:Lcom/google/firebase/iid/zzx;
...
.method private final zze(Landroid/content/Context;Landroid/content/Intent;)I
    ...
    iget-object v1, p0, Lcom/google/firebase/iid/zzx;->zznzq:Landroid/support/v4/util/SimpleArrayMap;

    monitor-enter v1

    :try_start_0
    iget-object v0, p0, Lcom/google/firebase/iid/zzx;->zznzq:Landroid/support/v4/util/SimpleArrayMap;
    ...
    :goto_0
    :try_start_1
    iget-object v0, p0, Lcom/google/firebase/iid/zzx;->zznzr:Ljava/lang/Boolean;
    ...
    :try_start_3
    iget-object v3, p0, Lcom/google/firebase/iid/zzx;->zznzq:Landroid/support/v4/util/SimpleArrayMap;
...
.method public final zza(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)I
    ...
    :pswitch_0
    iget-object v0, p0, Lcom/google/firebase/iid/zzx;->zznzs:Ljava/util/Queue;
    ...
    invoke-direct {p0, p1, v0}, Lcom/google/firebase/iid/zzx;->zze(Landroid/content/Context;Landroid/content/Intent;)I
    ...
    :pswitch_1
    iget-object v0, p0, Lcom/google/firebase/iid/zzx;->zznzt:Ljava/util/Queue;
