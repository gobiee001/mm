...
.method static synthetic access$000(Lcom/newrelic/agent/android/background/ApplicationStateMonitor;)Ljava/util/concurrent/locks/Lock;
    .locals 1
    .param p0, "x0"    # Lcom/newrelic/agent/android/background/ApplicationStateMonitor;
...
.method private notifyApplicationInBackground()V
    ...
    .prologue
    .line 162
    sget-object v3, Lcom/newrelic/agent/android/background/ApplicationStateMonitor;->log:Lcom/newrelic/agent/android/logging/AgentLog;

    const-string v4, "Application appears to have gone to the background"
    ...
    iget-object v3, p0, Lcom/newrelic/agent/android/background/ApplicationStateMonitor;->applicationStateListeners:Ljava/util/ArrayList;

    invoke-direct {v2, v3}, Ljava/util/ArrayList;-><init>(Ljava/util/Collection;)V

    .line 166
    .local v2, "listeners":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/newrelic/agent/android/background/ApplicationStateListener;>;"
    monitor-exit v4
    :try_end_0
    ...
    .line 169
    .local v1, "listener":Lcom/newrelic/agent/android/background/ApplicationStateListener;
    ...
    .end local v1    # "listener":Lcom/newrelic/agent/android/background/ApplicationStateListener;
    .end local v2    # "listeners":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/newrelic/agent/android/background/ApplicationStateListener;>;"
    :catchall_0
    move-exception v3
    ...
    .restart local v2    # "listeners":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/newrelic/agent/android/background/ApplicationStateListener;>;"
    :cond_0
    return-void
.end method
