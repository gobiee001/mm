...
.method public asJsonArray()Lcom/newrelic/com/google/gson/JsonArray;
    ...
    iget-object v7, p0, Lcom/newrelic/agent/android/harvest/HarvestData;->dataToken:Lcom/newrelic/agent/android/harvest/DataToken;

    invoke-virtual {v7}, Lcom/newrelic/agent/android/harvest/DataToken;->asJson()Lcom/newrelic/com/google/gson/JsonElement;
    ...
    .line 70
    iget-object v7, p0, Lcom/newrelic/agent/android/harvest/HarvestData;->deviceInformation:Lcom/newrelic/agent/android/harvest/DeviceInformation;

    invoke-virtual {v7}, Lcom/newrelic/agent/android/harvest/DeviceInformation;->asJson()Lcom/newrelic/com/google/gson/JsonElement;
    ...
    iget-wide v8, p0, Lcom/newrelic/agent/android/harvest/HarvestData;->harvestTimeDelta:D
    ...
    .line 72
    iget-object v7, p0, Lcom/newrelic/agent/android/harvest/HarvestData;->httpTransactions:Lcom/newrelic/agent/android/harvest/HttpTransactions;

    invoke-virtual {v7}, Lcom/newrelic/agent/android/harvest/HttpTransactions;->asJson()Lcom/newrelic/com/google/gson/JsonElement;
    ...
    .line 73
    iget-object v7, p0, Lcom/newrelic/agent/android/harvest/HarvestData;->machineMeasurements:Lcom/newrelic/agent/android/harvest/MachineMeasurements;

    invoke-virtual {v7}, Lcom/newrelic/agent/android/harvest/MachineMeasurements;->asJson()Lcom/newrelic/com/google/gson/JsonElement;
    ...
    .line 74
    iget-object v7, p0, Lcom/newrelic/agent/android/harvest/HarvestData;->httpErrors:Lcom/newrelic/agent/android/harvest/HttpErrors;

    invoke-virtual {v7}, Lcom/newrelic/agent/android/harvest/HttpErrors;->asJson()Lcom/newrelic/com/google/gson/JsonElement;
    ...
    .line 76
    iget-object v7, p0, Lcom/newrelic/agent/android/harvest/HarvestData;->activityTraces:Lcom/newrelic/agent/android/harvest/ActivityTraces;

    invoke-virtual {v7}, Lcom/newrelic/agent/android/harvest/ActivityTraces;->asJson()Lcom/newrelic/com/google/gson/JsonElement;
    ...
    invoke-virtual {v8}, Lcom/newrelic/agent/android/harvest/HarvestConfiguration;->getActivity_trace_max_size()I
    ...
    .line 86
    :goto_0
    iget-object v7, p0, Lcom/newrelic/agent/android/harvest/HarvestData;->agentHealth:Lcom/newrelic/agent/android/harvest/AgentHealth;

    invoke-virtual {v7}, Lcom/newrelic/agent/android/harvest/AgentHealth;->asJson()Lcom/newrelic/com/google/gson/JsonElement;
    ...
    .line 88
    iget-boolean v7, p0, Lcom/newrelic/agent/android/harvest/HarvestData;->analyticsEnabled:Z
    ...
    .line 90
    .local v6, "sessionAttrObj":Lcom/newrelic/com/google/gson/JsonObject;
    ...
    invoke-virtual {v6, v8, v9}, Lcom/newrelic/com/google/gson/JsonObject;->addProperty(Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_1

    .line 83
    .end local v3    # "attribute":Lcom/newrelic/agent/android/analytics/AnalyticAttribute;
    .end local v6    # "sessionAttrObj":Lcom/newrelic/com/google/gson/JsonObject;
    :cond_0
    invoke-static {}, Lcom/newrelic/agent/android/stats/StatsEngine;->get()Lcom/newrelic/agent/android/stats/StatsEngine;

    move-result-object v7

    const-string v8, "Supportability/AgentHealth/BigActivityTracesDropped"
    ...
    invoke-virtual {v7, v8, v9}, Lcom/newrelic/agent/android/stats/StatsEngine;->sample(Ljava/lang/String;F)V

    goto :goto_0

    .line 96
    .restart local v3    # "attribute":Lcom/newrelic/agent/android/analytics/AnalyticAttribute;
    .restart local v6    # "sessionAttrObj":Lcom/newrelic/com/google/gson/JsonObject;
    :pswitch_1
    invoke-virtual {v3}, Lcom/newrelic/agent/android/analytics/AnalyticAttribute;->getName()Ljava/lang/String;
    ...
    invoke-virtual {v6, v8, v9}, Lcom/newrelic/com/google/gson/JsonObject;->addProperty(Ljava/lang/String;Ljava/lang/Number;)V
    ...
    invoke-virtual {v6, v8, v9}, Lcom/newrelic/com/google/gson/JsonObject;->addProperty(Ljava/lang/String;Ljava/lang/Boolean;)V
    ...
    .end local v3    # "attribute":Lcom/newrelic/agent/android/analytics/AnalyticAttribute;
    :cond_1
    invoke-virtual {v2, v6}, Lcom/newrelic/com/google/gson/JsonArray;->add(Lcom/newrelic/com/google/gson/JsonElement;)V
    ...
    iget-object v7, p0, Lcom/newrelic/agent/android/harvest/HarvestData;->analyticsEvents:Ljava/util/Collection;
