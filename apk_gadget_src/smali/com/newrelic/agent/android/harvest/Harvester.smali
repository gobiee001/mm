...
.method private fireOnHarvest()V
    ...
    const-string v3, "Error in fireOnHarvest"
...
.method private fireOnHarvestBefore()V
    ...
    const-string v3, "Error in fireOnHarvestBefore"
...
.method private fireOnHarvestComplete()V
    ...
    const-string v3, "Error in fireOnHarvestComplete"
...
.method private fireOnHarvestConnected()V
    ...
    const-string v3, "Error in fireOnHarvestConnected"
...
.method private fireOnHarvestDisabled()V
    ...
    const-string v3, "Error in fireOnHarvestDisabled"
...
.method private fireOnHarvestDisconnected()V
    ...
    const-string v3, "Error in fireOnHarvestDisconnected"
...
.method private fireOnHarvestError()V
    ...
    const-string v3, "Error in fireOnHarvestError"
...
.method private fireOnHarvestFinalize()V
    ...
    const-string v3, "Error in fireOnHarvestFinalize"
...
.method private fireOnHarvestSendFailed()V
    ...
    const-string v3, "Error in fireOnHarvestSendFailed"
...
.method private fireOnHarvestStart()V
    ...
    const-string v3, "Error in fireOnHarvestStart"
...
.method private fireOnHarvestStop()V
    ...
    const-string v3, "Error in fireOnHarvestStop"
...
.method private varargs stateIn(Lcom/newrelic/agent/android/harvest/Harvester$State;[Lcom/newrelic/agent/android/harvest/Harvester$State;)Z
    ...
    .line 425
    .local v0, "state":Lcom/newrelic/agent/android/harvest/Harvester$State;
    if-ne p1, v0, :cond_1
    ...
    .line 427
    .end local v0    # "state":Lcom/newrelic/agent/android/harvest/Harvester$State;
    :cond_0
    return v1

    .line 424
    .restart local v0    # "state":Lcom/newrelic/agent/android/harvest/Harvester$State;
    :cond_1
...
.method public expireActivityTraces()V
    ...
    invoke-virtual {v5}, Lcom/newrelic/agent/android/harvest/HarvestData;->getActivityTraces()Lcom/newrelic/agent/android/harvest/ActivityTraces;

    move-result-object v4

    .line 531
    .local v4, "traces":Lcom/newrelic/agent/android/harvest/ActivityTraces;
    monitor-enter v4
    ...
    iget-object v5, p0, Lcom/newrelic/agent/android/harvest/Harvester;->configuration:Lcom/newrelic/agent/android/harvest/HarvestConfiguration;

    invoke-virtual {v5}, Lcom/newrelic/agent/android/harvest/HarvestConfiguration;->getActivity_trace_max_report_attempts()I
    ...
    invoke-virtual {v1}, Lcom/newrelic/agent/android/tracing/ActivityTrace;->getReportAttemptCount()J
    ...
    .line 546
    .restart local v1    # "trace":Lcom/newrelic/agent/android/tracing/ActivityTrace;
    invoke-virtual {v4, v1}, Lcom/newrelic/agent/android/harvest/ActivityTraces;->remove(Lcom/newrelic/agent/android/tracing/ActivityTrace;)V
...
.method public expireHttpErrors()V
    ...
    .line 483
    .local v6, "oldErrors":Ljava/util/Collection;, "Ljava/util/Collection<Lcom/newrelic/agent/android/harvest/HttpError;>;"
    ...
    .line 484
    .local v4, "now":J
    iget-object v7, p0, Lcom/newrelic/agent/android/harvest/Harvester;->configuration:Lcom/newrelic/agent/android/harvest/HarvestConfiguration;

    invoke-virtual {v7}, Lcom/newrelic/agent/android/harvest/HarvestConfiguration;->getReportMaxTransactionAgeMilliseconds()J
    ...
    .end local v4    # "now":J
    .end local v6    # "oldErrors":Ljava/util/Collection;, "Ljava/util/Collection<Lcom/newrelic/agent/android/harvest/HttpError;>;"
    :catchall_0
    move-exception v7
    ...
    .restart local v6    # "oldErrors":Ljava/util/Collection;, "Ljava/util/Collection<Lcom/newrelic/agent/android/harvest/HttpError;>;"
    :cond_1
    :try_start_1
...
.method public expireHttpTransactions()V
    ...
    .line 506
    .local v5, "transactions":Lcom/newrelic/agent/android/harvest/HttpTransactions;
    monitor-enter v5
    ...
    .line 508
    .local v4, "oldTransactions":Ljava/util/Collection;, "Ljava/util/Collection<Lcom/newrelic/agent/android/harvest/HttpTransaction;>;"
    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J
    ...
    .line 512
    .local v0, "maxAge":J
    invoke-virtual {v5}, Lcom/newrelic/agent/android/harvest/HttpTransactions;->getHttpTransactions()Ljava/util/Collection;
    ...
    check-cast v6, Lcom/newrelic/agent/android/harvest/HttpTransaction;

    .line 513
    .local v6, "txn":Lcom/newrelic/agent/android/harvest/HttpTransaction;
    invoke-virtual {v6}, Lcom/newrelic/agent/android/harvest/HttpTransaction;->getTimestamp()Ljava/lang/Long;
    ...
    .end local v2    # "now":J
    .end local v4    # "oldTransactions":Ljava/util/Collection;, "Ljava/util/Collection<Lcom/newrelic/agent/android/harvest/HttpTransaction;>;"
    .end local v6    # "txn":Lcom/newrelic/agent/android/harvest/HttpTransaction;
    :catchall_0
    move-exception v7
    ...
    .restart local v4    # "oldTransactions":Ljava/util/Collection;, "Ljava/util/Collection<Lcom/newrelic/agent/android/harvest/HttpTransaction;>;"
    :cond_1
    :try_start_1
    ...
    .line 521
    .restart local v6    # "txn":Lcom/newrelic/agent/android/harvest/HttpTransaction;
    invoke-virtual {v5, v6}, Lcom/newrelic/agent/android/harvest/HttpTransactions;->remove(Lcom/newrelic/agent/android/harvest/HttpTransaction;)V
