...
.method public broadcastMeasurements()V
    ...
    .line 121
    :try_start_0
    iget-object v7, p0, Lcom/newrelic/agent/android/measurement/MeasurementPool;->producers:Ljava/util/Collection;
    ...
    check-cast v6, Lcom/newrelic/agent/android/measurement/producer/MeasurementProducer;

    .line 122
    .local v6, "producer":Lcom/newrelic/agent/android/measurement/producer/MeasurementProducer;
    invoke-interface {v6}, Lcom/newrelic/agent/android/measurement/producer/MeasurementProducer;->drainMeasurements()Ljava/util/Collection;

    move-result-object v4

    .line 123
    .local v4, "measurements":Ljava/util/Collection;, "Ljava/util/Collection<Lcom/newrelic/agent/android/measurement/Measurement;>;"
    ...
    .line 131
    .end local v4    # "measurements":Ljava/util/Collection;, "Ljava/util/Collection<Lcom/newrelic/agent/android/measurement/Measurement;>;"
    .end local v6    # "producer":Lcom/newrelic/agent/android/measurement/producer/MeasurementProducer;
    :cond_1
    monitor-exit v8
    :try_end_0
    ...
    .line 137
    :try_start_1
    iget-object v7, p0, Lcom/newrelic/agent/android/measurement/MeasurementPool;->consumers:Ljava/util/Collection;
    ...
    .line 142
    .local v5, "measurements":Ljava/util/List;, "Ljava/util/List<Lcom/newrelic/agent/android/measurement/Measurement;>;"
    ...
    .line 143
    .local v3, "measurement":Lcom/newrelic/agent/android/measurement/Measurement;
    ...
    .line 149
    sget-object v10, Lcom/newrelic/agent/android/measurement/MeasurementPool;->log:Lcom/newrelic/agent/android/logging/AgentLog;
    ...
    .end local v3    # "measurement":Lcom/newrelic/agent/android/measurement/Measurement;
    .end local v5    # "measurements":Ljava/util/List;, "Ljava/util/List<Lcom/newrelic/agent/android/measurement/Measurement;>;"
    :catchall_0
    move-exception v7
