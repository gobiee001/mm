...
.method private summarizeActivityMetrics(Lcom/newrelic/agent/android/tracing/ActivityTrace;)V
    ...
    iget-object v14, v0, Lcom/newrelic/agent/android/tracing/ActivityTrace;->rootTrace:Lcom/newrelic/agent/android/tracing/Trace;

    .line 140
    .local v14, "trace":Lcom/newrelic/agent/android/tracing/Trace;
    ...
    iget-object v0, v14, Lcom/newrelic/agent/android/tracing/Trace;->metricName:Ljava/lang/String;

    move-object/from16 v19, v0

    invoke-virtual/range {v18 .. v19}, Lcom/newrelic/agent/android/metric/MetricStore;->removeAllWithScope(Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v0, v14, Lcom/newrelic/agent/android/tracing/Trace;->metricBackgroundName:Ljava/lang/String;
    ...
    .line 148
    .local v7, "summaryMetrics":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Lcom/newrelic/agent/android/metric/Metric;>;"
    ...
    check-cast v18, Lcom/newrelic/agent/android/metric/Metric;
    ...
    .line 164
    .local v12, "totalExclusiveTime":D
    ...
    .line 165
    .local v6, "metric":Lcom/newrelic/agent/android/metric/Metric;
    ...
    .line 168
    .end local v6    # "metric":Lcom/newrelic/agent/android/metric/Metric;
    :cond_3
    iget-wide v0, v14, Lcom/newrelic/agent/android/tracing/Trace;->exitTimestamp:J

    move-wide/from16 v18, v0

    iget-wide v0, v14, Lcom/newrelic/agent/android/tracing/Trace;->entryTimestamp:J
    ...
    .line 172
    .restart local v6    # "metric":Lcom/newrelic/agent/android/metric/Metric;
    ...
    invoke-virtual {v6, v0}, Lcom/newrelic/agent/android/metric/Metric;->setTotal(Ljava/lang/Double;)V
    ...
    invoke-virtual {v6, v0}, Lcom/newrelic/agent/android/metric/Metric;->setExclusive(Ljava/lang/Double;)V
    ...
    invoke-virtual {v6, v0}, Lcom/newrelic/agent/android/metric/Metric;->setMinFieldValue(Ljava/lang/Double;)V
    ...
    invoke-virtual {v6, v0}, Lcom/newrelic/agent/android/metric/Metric;->setMaxFieldValue(Ljava/lang/Double;)V
    ...
    invoke-virtual {v6, v0}, Lcom/newrelic/agent/android/metric/Metric;->setSumOfSquares(Ljava/lang/Double;)V
    ...
    iget-object v0, v14, Lcom/newrelic/agent/android/tracing/Trace;->displayName:Ljava/lang/String;
    ...
    invoke-virtual {v6, v0}, Lcom/newrelic/agent/android/metric/Metric;->setScope(Ljava/lang/String;)V

    .line 189
    invoke-static {v6}, Lcom/newrelic/agent/android/harvest/Harvest;->addMetric(Lcom/newrelic/agent/android/metric/Metric;)V

    .line 191
    new-instance v15, Lcom/newrelic/agent/android/metric/Metric;

    invoke-direct {v15, v6}, Lcom/newrelic/agent/android/metric/Metric;-><init>(Lcom/newrelic/agent/android/metric/Metric;)V

    .line 192
    .local v15, "unScoped":Lcom/newrelic/agent/android/metric/Metric;
    const/16 v19, 0x0

    move-object/from16 v0, v19

    invoke-virtual {v15, v0}, Lcom/newrelic/agent/android/metric/Metric;->setScope(Ljava/lang/String;)V

    .line 193
    invoke-static {v15}, Lcom/newrelic/agent/android/harvest/Harvest;->addMetric(Lcom/newrelic/agent/android/metric/Metric;)V
    ...
    .end local v15    # "unScoped":Lcom/newrelic/agent/android/metric/Metric;
    :cond_5
...
.method public onHarvest()V
    ...
    .line 98
    :cond_1
    iget-object v1, p0, Lcom/newrelic/agent/android/measurement/consumer/SummaryMetricMeasurementConsumer;->completedTraces:Ljava/util/List;
    ...
    .line 104
    .local v0, "trace":Lcom/newrelic/agent/android/tracing/ActivityTrace;
    invoke-direct {p0, v0}, Lcom/newrelic/agent/android/measurement/consumer/SummaryMetricMeasurementConsumer;->summarizeActivityMetrics(Lcom/newrelic/agent/android/tracing/ActivityTrace;)V

    goto :goto_1

    .line 107
    .end local v0    # "trace":Lcom/newrelic/agent/android/tracing/ActivityTrace;
    :cond_2
    iget-object v1, p0, Lcom/newrelic/agent/android/measurement/consumer/SummaryMetricMeasurementConsumer;->metrics:Lcom/newrelic/agent/android/metric/MetricStore;
    ...
    .line 108
    sget-object v1, Lcom/newrelic/agent/android/measurement/consumer/SummaryMetricMeasurementConsumer;->log:Lcom/newrelic/agent/android/logging/AgentLog;

    const-string v2, "Not all metrics were summarized!"
