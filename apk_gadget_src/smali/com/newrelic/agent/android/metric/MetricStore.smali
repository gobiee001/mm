...
.method public getAllByScope(Ljava/lang/String;)Ljava/util/List;
    ...
    .line 63
    .local v1, "metrics":Ljava/util/List;, "Ljava/util/List<Lcom/newrelic/agent/android/metric/Metric;>;"
    :try_start_0
    iget-object v2, p0, Lcom/newrelic/agent/android/metric/MetricStore;->metricStore:Ljava/util/Map;
    ...
    .line 64
    .local v0, "metricEntry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Lcom/newrelic/agent/android/metric/Metric;>;"
    invoke-interface {v0}, Ljava/util/Map$Entry;->getValue()Ljava/lang/Object;
    ...
    .line 66
    .end local v0    # "metricEntry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Lcom/newrelic/agent/android/metric/Metric;>;"
    :catch_0
    move-exception v2
...
.method public removeAll(Ljava/util/List;)V
    ...
    invoke-virtual {p0, v0}, Lcom/newrelic/agent/android/metric/MetricStore;->remove(Lcom/newrelic/agent/android/metric/Metric;)V
