...
.method public static fromErrorCode(I)Lcom/newrelic/agent/android/util/NetworkFailure;
    ...
    const-string v3, "fromErrorCode invoked with errorCode: "
    ...
    .line 61
    .local v0, "failure":Lcom/newrelic/agent/android/util/NetworkFailure;
    invoke-virtual {v0}, Lcom/newrelic/agent/android/util/NetworkFailure;->getErrorCode()I
    ...
    const-string v3, "fromErrorCode found matching failure: "
    ...
    .line 66
    .end local v0    # "failure":Lcom/newrelic/agent/android/util/NetworkFailure;
    :goto_1
    return-object v0

    .line 60
    .restart local v0    # "failure":Lcom/newrelic/agent/android/util/NetworkFailure;
    :cond_0
