...
.method public intercept(Lokhttp3/Interceptor$Chain;)Lokhttp3/Response;
    ...
    .line 93
    :cond_6
    instance-of v14, v8, Lokhttp3/Request$Builder;
    ...
    .line 97
    instance-of v14, v7, Lokhttp3/Response$Builder;
    ...
    invoke-direct {v15, v11, v14}, Lokhttp3/internal/http/RealResponseBody;-><init>(Lokhttp3/Headers;Lokio/BufferedSource;)V

    instance-of v14, v10, Lokhttp3/Response$Builder;

    if-nez v14, :cond_b

    invoke-virtual {v10, v15}, Lokhttp3/Response$Builder;->body(Lokhttp3/ResponseBody;)Lokhttp3/Response$Builder;
    ...
    .restart local v8    # "requestBuilder":Lokhttp3/Request$Builder;
    :cond_8
    const-string v14, "Transfer-Encoding"
    ...
    .end local v3    # "contentType":Lokhttp3/MediaType;
    .end local v4    # "contentLength":J
    .restart local v6    # "cookies":Ljava/util/List;, "Ljava/util/List<Lokhttp3/Cookie;>;"
    .restart local v12    # "transparentGzip":Z
    :cond_9
    check-cast v8, Lokhttp3/Request$Builder;

    .end local v8    # "requestBuilder":Lokhttp3/Request$Builder;
    invoke-static {v8}, Lcom/newrelic/agent/android/instrumentation/okhttp3/OkHttp3Instrumentation;->build(Lokhttp3/Request$Builder;)Lokhttp3/Request;

    move-result-object v14

    goto/16 :goto_1

    .restart local v7    # "networkResponse":Lokhttp3/Response;
    :cond_a
    move-object v14, v7

    .line 97
    check-cast v14, Lokhttp3/Response$Builder;

    invoke-static {v14}, Lcom/newrelic/agent/android/instrumentation/okhttp3/OkHttp3Instrumentation;->newBuilder(Lokhttp3/Response$Builder;)Lokhttp3/Response$Builder;

    move-result-object v14

    goto :goto_2

    .restart local v9    # "responseBody":Lokio/GzipSource;
    .restart local v10    # "responseBuilder":Lokhttp3/Response$Builder;
    .restart local v11    # "strippedHeaders":Lokhttp3/Headers;
    :cond_b
    move-object v14, v10
    ...
    invoke-static {v14, v15}, Lcom/newrelic/agent/android/instrumentation/okhttp3/OkHttp3Instrumentation;->body(Lokhttp3/Response$Builder;Lokhttp3/ResponseBody;)Lokhttp3/Response$Builder;
