...
.method private followUpRequest(Lokhttp3/Response;)Lokhttp3/Request;
    ...
    instance-of v12, v11, Lokhttp3/Request$Builder;
    ...
    invoke-static {v11}, Lcom/newrelic/agent/android/instrumentation/okhttp3/OkHttp3Instrumentation;->build(Lokhttp3/Request$Builder;)Lokhttp3/Request;
...
.method public intercept(Lokhttp3/Interceptor$Chain;)Lokhttp3/Response;
    ...
    .line 107
    invoke-virtual {v10}, Lokhttp3/OkHttpClient;->connectionPool()Lokhttp3/ConnectionPool;
    ...
    invoke-direct {v9, v10, v12, v13}, Lokhttp3/internal/connection/StreamAllocation;-><init>(Lokhttp3/ConnectionPool;Lokhttp3/Address;Ljava/lang/Object;)V
    ...
    invoke-virtual {v9, v6, v10, v12, v13}, Lokhttp3/internal/http/RealInterceptorChain;->proceed(Lokhttp3/Request;Lokhttp3/internal/connection/StreamAllocation;Lokhttp3/internal/http/HttpCodec;Lokhttp3/Connection;)Lokhttp3/Response;
    :try_end_0
    ...
    .line 145
    instance-of v9, v8, Lokhttp3/Response$Builder;
    ...
    :goto_1
    instance-of v9, v4, Lokhttp3/Response$Builder;
    ...
    :goto_2
    instance-of v12, v9, Lokhttp3/Response$Builder;

    if-nez v12, :cond_b

    invoke-virtual {v9, v14}, Lokhttp3/Response$Builder;->body(Lokhttp3/ResponseBody;)Lokhttp3/Response$Builder;
    ...
    .line 146
    invoke-virtual {v10, v9}, Lokhttp3/Response$Builder;->priorResponse(Lokhttp3/Response;)Lokhttp3/Response$Builder;
    ...
    invoke-direct {p0, v9, v10, v6}, Lokhttp3/internal/http/RetryAndFollowUpInterceptor;->recover(Ljava/io/IOException;ZLokhttp3/Request;)Z
    ...
    .end local v7    # "requestSendStarted":Z
    :cond_9
    check-cast v8, Lokhttp3/Response$Builder;

    .end local v8    # "response":Lokhttp3/Response;
    invoke-static {v8}, Lcom/newrelic/agent/android/instrumentation/okhttp3/OkHttp3Instrumentation;->newBuilder(Lokhttp3/Response$Builder;)Lokhttp3/Response$Builder;
    ...
    invoke-static {v9, v14}, Lcom/newrelic/agent/android/instrumentation/okhttp3/OkHttp3Instrumentation;->body(Lokhttp3/Response$Builder;Lokhttp3/ResponseBody;)Lokhttp3/Response$Builder;
