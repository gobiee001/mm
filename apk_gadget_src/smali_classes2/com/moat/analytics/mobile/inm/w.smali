...
# static fields
.field private static g:Lcom/moat/analytics/mobile/inm/w;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/moat/analytics/mobile/inm/w;->h:Ljava/util/Queue;
...
.method private constructor <init>()V
    ...
    iput-wide v0, p0, Lcom/moat/analytics/mobile/inm/w;->e:J
    ...
    iput-object v0, p0, Lcom/moat/analytics/mobile/inm/w;->j:Ljava/util/concurrent/atomic/AtomicBoolean;

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lcom/moat/analytics/mobile/inm/w;->k:J

    new-instance v0, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {v0, v2}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>(I)V

    iput-object v0, p0, Lcom/moat/analytics/mobile/inm/w;->l:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0, v2}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v0, p0, Lcom/moat/analytics/mobile/inm/w;->m:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, Lcom/moat/analytics/mobile/inm/w;->i:Landroid/os/Handler;
    :try_end_0
...
.method static synthetic a(Lcom/moat/analytics/mobile/inm/w;J)J
    ...
    iput-wide p1, p0, Lcom/moat/analytics/mobile/inm/w;->k:J
...
.method static declared-synchronized a()Lcom/moat/analytics/mobile/inm/w;
    ...
    :try_start_0
    sget-object v0, Lcom/moat/analytics/mobile/inm/w;->g:Lcom/moat/analytics/mobile/inm/w;
    ...
    sput-object v0, Lcom/moat/analytics/mobile/inm/w;->g:Lcom/moat/analytics/mobile/inm/w;
...
.method private a(J)V
    ...
    iget-object v0, p0, Lcom/moat/analytics/mobile/inm/w;->m:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method static synthetic b(Lcom/moat/analytics/mobile/inm/w;)Landroid/os/Handler;
    ...
    iget-object v0, p0, Lcom/moat/analytics/mobile/inm/w;->i:Landroid/os/Handler;
...
.method static synthetic c()Ljava/util/Queue;
    ...
    sget-object v0, Lcom/moat/analytics/mobile/inm/w;->h:Ljava/util/Queue;
...
.method static synthetic c(Lcom/moat/analytics/mobile/inm/w;)Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v0, p0, Lcom/moat/analytics/mobile/inm/w;->j:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private d()V
    ...
    sget-object v1, Lcom/moat/analytics/mobile/inm/w;->h:Ljava/util/Queue;
    ...
    sget-object v2, Lcom/moat/analytics/mobile/inm/w;->h:Ljava/util/Queue;
...
.method static synthetic e(Lcom/moat/analytics/mobile/inm/w;)Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v0, p0, Lcom/moat/analytics/mobile/inm/w;->l:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method private e()V
    ...
    iget-object v1, p0, Lcom/moat/analytics/mobile/inm/w;->i:Landroid/os/Handler;
...
.method a(Lcom/moat/analytics/mobile/inm/w$b;)V
    ...
    invoke-interface {p1}, Lcom/moat/analytics/mobile/inm/w$b;->b()V
...
.method b()V
    ...
    iget-wide v2, p0, Lcom/moat/analytics/mobile/inm/w;->k:J

    sub-long/2addr v0, v2

    iget-wide v2, p0, Lcom/moat/analytics/mobile/inm/w;->e:J
